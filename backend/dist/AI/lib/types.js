...
exports.MessageSchema = zod_1.z.object({
    ...
    videoData: exports.VideoDataSchema.optional(),
    image: exports.ImageSchema.optional(),
    isError: zod_1.z.boolean().optional(),
    sources: zod_1.z.array(zod_1.z.any()).optional(),
...
exports.ChatSessionSchema = zod_1.z.object({
    id: zod_1.z.string(),
    title: zod_1.z.string().optional(), // Marking as optional since backend uses 'topic'
    topic: zod_1.z.string().nullable().optional(),
    messages: zod_1.z.array(exports.MessageSchema).optional(),
    createdAt: zod_1.z.string(), // Expecting string from API
    updatedAt: zod_1.z.string(), // Expecting string from API
    metadata: zod_1.z.any().optional(),
    conversationState: exports.ConversationStateSchema.optional(), // Added conversationState
...
exports.UserProfileSchema = zod_1.z.object({
    ...
    interests: zod_1.z.array(zod_1.z.string()).optional(), // Changed from topInterests
