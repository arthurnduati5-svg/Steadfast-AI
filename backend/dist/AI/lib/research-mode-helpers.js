...
function classifySensitiveContent(input) {
...
export async function classifyKidInput(input, state, currentTopic) {
    ...
    const previousTopic = topicStack.length > 1 ? topicStack[topicStack.length - 2] : null;
    const prompt = `
    ...
    - Awaiting Practice Question Invitation Response: ${state.awaitingPracticeQuestionInvitationResponse}
    - Awaiting Answer to a Practice Question: ${state.awaitingPracticeQuestionAnswer}
...
//# sourceMappingURL=research-mode-helpers.js.map