...
// ─── Result Release Routes (Package 11) ──
...
// ─── Result Report Card Routes (Package 13) ──
import resultReportCardRoutes from './routes/resultReportCard';
app.use('/api/question-bank/result-report-cards', schoolAuthMiddleware, requireVerifiedSchoolContext, resultReportCardRoutes);

// ─── Result Report Card Export Routes (Package 14) ──
...
// ─── Result Recovery Planner Routes (Package 17) ──
...
// ─── Recovery Outcome Decision Gate Routes (Package 19) ──
import recoveryOutcomeRoutes from './routes/recoveryOutcome';
app.use('/api/question-bank/recovery-outcome', schoolAuthMiddleware, requireVerifiedSchoolContext, recoveryOutcomeRoutes);

// ─── Recovery Outcome Action Preparation Routes (Package 20) ──
