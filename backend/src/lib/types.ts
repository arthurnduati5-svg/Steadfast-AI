...
export const PracticePadSupportChoiceSchema = z.enum(['retry_first', 'hint', 'example', 'break_down']);
export type PracticePadSupportChoice = z.infer<typeof PracticePadSupportChoiceSchema>;
export const PracticePadStepFocusSchema = z.enum(['whole_problem', 'selected_step', 'checking_work', 'stuck_point']);
export type PracticePadStepFocus = z.infer<typeof PracticePadStepFocusSchema>;
...
export const MessageLanguageMetadataSchema = z.object({
  detectedInputLanguage: DetectedInputLanguageSchema.nullable().optional(),
  preferredResponseLanguageAtTurn: SupportedLearningLanguageSchema.nullable().optional(),
  learningSupportModeAtTurn: LearningSupportModeSchema.nullable().optional(),
  generatedLanguage: SupportedLearningLanguageSchema.nullable().optional(),
  sourceInputLanguage: DetectedInputLanguageSchema.nullable().optional(),
  voiceOutputLanguageAtTurn: SupportedLearningLanguageSchema.nullable().optional(),
  simplicityLevelAtTurn: SimplicityLevelSchema.nullable().optional(),
  preferredLanguageModeAtTurn: z.enum(['english', 'swahili', 'arabic', 'english_sw', 'arabic_english']).nullable().optional(),
});
export type MessageLanguageMetadata = z.infer<typeof MessageLanguageMetadataSchema>;
...
export const MetacognitiveEventSchema = z.object({
...
export type MetacognitiveEvent = z.infer<typeof MetacognitiveEventSchema>;

export const MetacognitiveProfileSchema = z.object({
  commonConfidencePattern: z.string().nullable().optional(),
  recurringErrorPatterns: z.array(z.string()).nullable().optional(),
  preferredSupportPatterns: z.array(z.string()).nullable().optional(),
  transferStrengths: z.array(z.string()).nullable().optional(),
  reflectionSignals: z.array(z.string()).nullable().optional(),
  explanationReadiness: z.enum(['emerging', 'developing', 'strong']).nullable().optional(),
  selfCorrectionTrend: z.enum(['improving', 'steady', 'needs_support']).nullable().optional(),
  recentSnapshot: MetacognitiveStateSnapshotSchema.nullable().optional(),
  lastReflectionSignal: ReflectionSignalSchema.nullable().optional(),
  evidenceCount: z.number().optional(),
  lastUpdatedAt: z.string().nullable().optional(),
});
export type MetacognitiveProfile = z.infer<typeof MetacognitiveProfileSchema>;

export const PracticePadReflectionPayloadSchema = MetacognitiveStateSnapshotSchema.extend({
  supportChoice: PracticePadSupportChoiceSchema.nullable().optional(),
  whatTryingToDo: z.string().nullable().optional(),
  leastSureStep: z.string().nullable().optional(),
});
export type PracticePadReflectionPayload = z.infer<typeof PracticePadReflectionPayloadSchema>;

export const PracticePadCheckStepRequestSchema = z.object({
  sessionId: z.string().nullable().optional(),
  prompt: z.string().nullable().optional(),
  workText: z.string(),
  selectedStep: z.string().nullable().optional(),
  topic: z.string().nullable().optional(),
  subject: z.string().nullable().optional(),
  supportChoice: PracticePadSupportChoiceSchema.nullable().optional(),
  stepFocus: PracticePadStepFocusSchema.nullable().optional(),
  reflection: PracticePadReflectionPayloadSchema.nullable().optional(),
  sourceMessageId: z.string().nullable().optional(),
});
export type PracticePadCheckStepRequest = z.infer<typeof PracticePadCheckStepRequestSchema>;

export const PracticePadCheckStepResponseSchema = z.object({
  sessionId: z.string().nullable().optional(),
  message: z.any().nullable().optional(),
  feedback: z.string(),
  diagnosis: z.string().nullable().optional(),
  nextStep: z.string(),
  suggestedSupport: PracticePadSupportChoiceSchema.nullable().optional(),
  reflectionPrompt: MetacognitivePromptSchema.nullable().optional(),
  detectedErrorType: MetacognitiveErrorTypeSchema.nullable().optional(),
  updatedMetacognitiveProfile: MetacognitiveProfileSchema.nullable().optional(),
});
export type PracticePadCheckStepResponse = z.infer<typeof PracticePadCheckStepResponseSchema>;
...
export const RevisionConnectionCategorySchema = z.enum(['theory', 'procedure', 'application', 'recovery']);
export type RevisionConnectionCategory = z.infer<typeof RevisionConnectionCategorySchema>;

export const RevisionConnectionStrengthSchema = z.enum(['light', 'moderate', 'strong']);
export type RevisionConnectionStrength = z.infer<typeof RevisionConnectionStrengthSchema>;

export const RevisionConnectionFieldSchema = z.enum([
  'tags',
  'topic',
  'subtopic',
  'subject',
...
export type RevisionConnectionField = z.infer<typeof RevisionConnectionFieldSchema>;

export const RevisionTagSuggestionSchema = z.object({
  from: z.string(),
  to: z.string(),
  reason: z.string(),
  kind: z.enum(['merge_duplicate', 'fix_spelling', 'mapped_synonym']),
});
export type RevisionTagSuggestion = z.infer<typeof RevisionTagSuggestionSchema>;

export const RevisionConnectionExplainabilitySchema = z.object({
  fields: z.array(RevisionConnectionFieldSchema),
  sharedTags: z.array(z.string()),
  sharedTitleTokens: z.array(z.string()),
  sameTopic: z.boolean(),
  sameSubtopic: z.boolean(),
  sameSubject: z.boolean(),
  mistakeBridge: z.boolean(),
});
export type RevisionConnectionExplainability = z.infer<typeof RevisionConnectionExplainabilitySchema>;

export const RevisionConnectedNoteLinkSchema = z.object({
  targetItemId: z.string(),
  targetTitle: z.string(),
  score: z.number(),
  category: RevisionConnectionCategorySchema,
  strength: RevisionConnectionStrengthSchema,
  whyConnected: z.string(),
  whySignals: z.array(z.string()),
  sharedTags: z.array(z.string()),
  explainability: RevisionConnectionExplainabilitySchema,
  actionStep: z.string(),
});
export type RevisionConnectedNoteLink = z.infer<typeof RevisionConnectedNoteLinkSchema>;

export const RevisionConnectedNoteGraphSchema = z.object({
  generatedAt: z.string(),
  totalLinks: z.number(),
  links: z.array(RevisionConnectedNoteLinkSchema),
  summaryLines: z.array(z.string()),
  tagSuggestions: z.array(RevisionTagSuggestionSchema),
});
export type RevisionConnectedNoteGraph = z.infer<typeof RevisionConnectedNoteGraphSchema>;
...
export const AssistantMessageEnvelopeRouteSchema = z.enum(['chat', 'voice_chat']);
export type AssistantMessageEnvelopeRoute = z.infer<typeof AssistantMessageEnvelopeRouteSchema>;

export const AssistantMessageEnvelopeSchema = z.object({
  version: z.literal('v1'),
  route: AssistantMessageEnvelopeRouteSchema,
  generatedAt: z.string(),
  tutorUi: TutorActionUiMetaSchema.optional(),
  presentation: MessagePresentationMetaSchema.optional(),
  systemNotices: z.array(SystemNoticeSchema).optional(),
  language: MessageLanguageMetadataSchema.optional(),
  metacognition: MetacognitiveStateSnapshotSchema.nullable().optional(),
  savedRevisionNote: TutorRevisionNoteSchema.optional(),
});
export type AssistantMessageEnvelope = z.infer<typeof AssistantMessageEnvelopeSchema>;
