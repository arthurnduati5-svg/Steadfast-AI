import type { AnswerProtectionResult } from '../contracts/quizModeContracts';
...
export function evaluateQuizAnswerProtection(input: AnswerProtectionInput): AnswerProtectionResult {
