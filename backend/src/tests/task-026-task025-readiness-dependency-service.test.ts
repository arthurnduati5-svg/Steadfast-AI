...
import { checkTask025ReadinessDependency, checkTask025FinalDecisionExists, checkTask025SafeToStartTask026, checkTask025CommitVisibility } from '../services/task026Task025ReadinessDependencyService';
import { task026PilotExecutionRepository } from '../repositories/task026PilotExecutionRepository';

describe('task026Task025ReadinessDependencyService', () => {
  ...
  describe('checkTask025ReadinessDependency', () => {
    ...
    it('returns passed when pilot run status is beyond preflight', async () => {
  ...
  describe('checkTask025FinalDecisionExists', () => {
    ...
    it('returns passed when owners are assigned', async () => {
      await task026PilotExecutionRepository.createPilotRun({
        schoolId: 'school-1', pilotProgramId: 'pp-1', status: 'ready',
